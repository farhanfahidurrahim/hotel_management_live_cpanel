            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Help and Support</h5>
                    </div>

					@if (!empty($data->id))
					<form method="POST" action="{{ route('help-support.update', $data->id) }}" class="form theme-form">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
					...
					@else
					<form method="POST" action="{{ route('help-support.store') }}" class="form theme-form">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
