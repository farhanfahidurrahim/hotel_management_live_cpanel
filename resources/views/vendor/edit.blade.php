...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form class="form theme-form" action="{{ route('vendor.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h5>Edit Vendor Info</h5>
                        </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="{{ asset('vendors_images/images/'.$user->image) }}" height="100" width="100" alt="" srcset="">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body animate-chk">
                                    <div class="row">
                                        <div class="auth-module">
                                            <p for="" class="header text-center display-6">{{ $user->name }}'s Permission</p>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 pl-0">
                                                    <div class="form-group form-check ">
                                                        ...
                                                        <label class="form-check-label" for="exampleCheck1">{{ $permission->permission_name }}</label> <a href="{{ route('vendor.permission.delete',$permission->id)  }}" class="btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </div>
                                                @endforeach
